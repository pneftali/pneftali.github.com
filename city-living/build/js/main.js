...
define('text!templates/index/indexTemplate.html',[],function () { return '<div class="item-wrap clearfix">\n<div class="mini specifics">\n\t<a class="posted"><i class="icon-clock-2"></i>&nbsp; <%= posted_date %></a>\n\t<a class="posted-by"><i class="icon-camera-3"></i>&nbsp; <%= posted_by %></a>\n\t<a class="posted-loc"><i class="icon-map-pin-fill"></i>&nbsp; <%= posted_location %></a>\n</div>\n\n<div class="ftd-box">\t\t  \n\t<div id="ftd-" class="shown">           \n\t\t<div id="c-box-left">              \n\t\t\t<div class="collage box-600 pull-left">\t\t\t\t\t\t\n\t\t\t\t<div class=\'top\'>            \n\t\t\t\t\t<div class="img-wrap wrap-main">\n\t\t\t\t\t\t<a href="<%= img_path %>/<%= id %>/fbox/main-fbox-<%= id %>.jpg" rel="<%= id %>">\n\t\t\t\t\t\t\t<img class="collage-main" src="<%= img_path %>/<%= id %>/main-<%= id %>.jpg">\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="img-wrap wrap-square">                  \n\t\t\t\t\t\t<a href="<%= img_path %>/<%= id %>/fbox/img-<%= id %>-0.jpg" rel="<%= id %>">\n\t\t\t\t\t\t\t<img class="collage-square" src="<%= img_path %>/<%= id %>/thumb/img-<%= id %>-0.jpg">\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="img-wrap wrap-square">\n\t\t\t\t\t\t<a href="<%= img_path %>/<%= id %>/fbox/img-<%= id %>-1.jpg" rel="<%= id %>">\n\t\t\t\t\t\t\t<img class="collage-square" src="<%= img_path %>/<%= id %>/thumb/img-<%= id %>-1.jpg">\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t</div><!-- end top -->\n\n\t\t\t\t<div class=\'btm\'>  \n\t\t\t\t\t<div class="img-wrap wrap-square">\n\t\t\t\t\t\t<a href="<%= img_path %>/<%= id %>/fbox/img-<%= id %>-2.jpg" rel="<%= id %>">\n\t\t\t\t\t\t\t<img class="collage-square" src="<%= img_path %>/<%= id %>/thumb/img-<%= id %>-2.jpg">\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="img-wrap wrap-square">\n\t\t\t\t\t\t<a href="<%= img_path %>/<%= id %>/fbox/img-<%= id %>-3.jpg" rel="<%= id %>">\n\t\t\t\t\t\t\t<img class="collage-square" src="<%= img_path %>/<%= id %>/thumb/img-<%= id %>-3.jpg">\n\t\t\t\t\t\t</a>          \n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="img-wrap wrap-square">\n\t\t\t\t\t\t<a href="<%= img_path %>/<%= id %>/fbox/img-<%= id %>-4.jpg" rel="<%= id %>">\n\t\t\t\t\t\t\t<img class="collage-square" src="<%= img_path %>/<%= id %>/thumb/img-<%= id %>-4.jpg">\n\t\t\t\t\t\t</a>               \n\t\t\t\t\t</div>\n\t\t\t\t</div><!-- end btm -->\n\t\t\t</div>                  \n\t\t</div><!-- end box-600 -->\n\t</div>  \n</div><!-- end featured -->\n\n<div class="c-box-right collage">\n\t<div class="info-box">\n\t\t<div class="info-content box">\n\t\t\t<h3><%= place_name %></h3>\n\t\t\t<p><%= place_details %></p>\t\t\t\n\t\t</div>\n\t</div>\n</div><!-- end right side box -->\n</div>';});
...
define('text!templates/submit/submitTemplate.html',[],function () { return '<div class="alert alert-info">\r\n\t<h4>Submit a place</h4>\r\n</div>\r\n\r\n<div class="well well-small">\r\n\t<h5>How this works ?</h5>\r\n\r\n\t<p>\r\n\t\t<span class="badge badge-success">1</span>\r\n\t\tFill out the <a href="#submit-form" title="Submit a site!">form</a> below about the basic information of the place.\r\n\t</p>\r\n\r\n\t<p>\r\n\t\t<span class="badge badge-success">2</span>\r\n\t\tWe take pictures of the unit/apartment/building.\r\n\t</p>\r\n\r\n\t<p>\r\n\t\t<span class="badge badge-success">3</span>\r\n\t\tPublish!\r\n\t</p>\r\n\r\n\t<p>\r\n\t\tSubmit as many as you want for free. They all go in queue - first come first serve basis. \r\n\t</p>\r\n\t<p>\r\n\t\tThe team currently go out taking pictures of the unit/apartment/building on weekends. And we normally start publishing the contents at the start of the week.\r\n\t</p>\r\n\t<p>\r\n\t\tOnly takes less than a minute! <a href="#submit-form" title="Submit a site!">GET GOING!</a>\r\n\t</p>\t\r\n</div>\r\n\r\n<iframe id="submit-form" src="https://docs.google.com/forms/d/1PJIyESzxtP9aOBrYYYZG79AAnbH1YNIsRDy_lN9e79E/viewform?embedded=true" width="960" height="600" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>';});
...
(H?' allowtransparency="true"':"")+"></iframe>",error:'<p class="fancybox-error">The requested content cannot be loaded.<br/>Please try again later.</p>',closeBtn:'<a title="Close" class="fancybox-item fancybox-close" href="javascript:;"><i class="icon-cancel-2"></i></a>',next:'<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><i class="icon-arrow-6"></i></a>',prev:'<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><i class="icon-arrow-9"></i></a>'},openEffect:"fade",openSpeed:250,openEasing:"swing",openOpacity:!0,
